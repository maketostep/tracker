...
export default function Header() {
  return (
      <AppBar position="static" elevation={1} sx={{ bgcolor: 'grey.100', color: 'grey.900', opacity: '0.7', ':hover': {opacity: '1'} }}>
        <Toolbar sx={{ justifyContent: 'space-between' }}>
          <Box display="flex" alignItems="center">
            ...
            <Typography variant="h6" fontWeight="bold" ml={2} component={NavLink} to='/' sx={{textDecoration: 'none', color: 'black'}} >
              Life Tracker
            </Typography>
            {' '}
